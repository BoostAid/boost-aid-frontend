...
const reviews = [
  {
    name: "Mark",
    username: "@Mark",
    body: "I got an answer I am happy with. Exactly what I needed.",
  ...
  },
  {
    name: "German",
    username: "@German",
    body: "I can now receive high-quality answers more quickly.",
    img: "https://avatar.vercel.sh/jane",
  },
  {
    name: "Andrew",
    username: "@Andrew",
    body: "Smart contracts guarantee that community members are rewarded for their contributions.",
