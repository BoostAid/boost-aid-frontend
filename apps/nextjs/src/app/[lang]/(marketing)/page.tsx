...
export default async function IndexPage({
  ...
  return (
    <>
      <section className="w-full h-[80vh] flex flex-col justify-center items-center px-8">
        <div className="text-center">
          ...
          <div className="mb-8">
            <h1 className="relative max-w-4xl text-3xl font-bold dark:text-zinc-100 sm:text-6xl">
              An amazing Q&A platform for all your needs.
            </h1>
          </div>
          <div className="flex justify-center mt-8 space-x-4">
            <Link href={`${lang}/login`}>
              <ShimmerButton className="flex justify-center">
      ...
      <section className="w-full py-16 bg-white dark:bg-gray-900"> {/* Changed background color */}
        <div className="text-center">
          <Comments />
        </div>
      </section>
